...
struct GlucoseBasedApplicationFactorStrategy: ApplicationFactorStrategy {
    static let minPartialApplicationFactor = 0.45 // min fraction of correction when glucose > minGlucoseSlidingScale
    ...
    static let minGlucoseDeltaSlidingScale = 7.0 // mg/dL
    static let maxGlucoseSlidingScale = 156.0 // mg/dL
